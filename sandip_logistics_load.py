...
sense_logistics_file = GCSObjectsWithPrefixExistenceSensor(
    ...
    bucket='landing-sandip-daily-file',
    prefix='Input_Data_daily/logistics_',
    mode='poke',
    timeout=300,
    poke_interval=30,
    dag=dag
...
create_hive_table = DataprocSubmitHiveJobOperator(
    ...
    query="""
        ...
        STORED AS TEXTFILE
        LOCATION 'gs://landing-sandip-daily-file/Input_Data_daily/'
...
archive_processed_file = BashOperator(
    ...
    bash_command=f"gsutil -m mv gs://landing-sandip-daily-file/Input_Data_daily/logistics_*.csv gs://archieve_file/",
    dag=dag
)
